...
export const SteeringWheelIcon = (props: { className?: string }) => (
  <SVGIcon {...props}>
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 3v3.75m0 11.25V21M3 12h3.75m11.25 0H21"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.343 6.343l2.404 2.404m9.899 9.9l-2.404-2.404"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M17.657 6.343l-2.404 2.404m-9.9 9.9l2.404-2.404"
    />
  </SVGIcon>
);
...
export const DocumentChartBarIcon = (props: { className?: string }) => (
  <SVGIcon {...props}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 17.25v-3.75m3.75 3.75v-6.75m3.75 6.75v-9.75M9 20.25h6.75M9 3.75H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H15M9 3.75V3"
    />
  </SVGIcon>
);
